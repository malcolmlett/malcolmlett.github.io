...
In this scenario, we will investigate the mechanisms required of a _control agent_, so that it can effectively monitor and control some remote target agent. We will draw a distinction between two variations:
...
## Autonomous Monitoring and Control (AMC)
