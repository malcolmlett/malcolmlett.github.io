...
* inspection                       <- great for simple things, but hard for large, complex, and dynamic systems
* description + interpretation     <- more complex, more machinery, but lots of benefits from description being independent from the original system. Physical structure of description is arbitrary.
