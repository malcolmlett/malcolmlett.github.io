...
Agents that operate within an external environment for the purpose of manipulating that environment (or part thereof) towards a target can be described as _regulators_ of that environment.
